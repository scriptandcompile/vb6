PROJECTS = [
    {
        ...
        "docsUrl": "https://scriptandcompile.github.io/vb6parse/",
        "notes": [
    ...
    },
    {
        ...
        "docsUrl": "https://github.com/scriptandcompile/vb6/tree/master/projects/vb6semantic/README.md",
        "notes": [
            "Depends on vb6parse for source structure.",
            "Needs a dedicated docs landing page."
        ]
    },
    {
        "slug": "vb6runtime",
    ...
    },
    {
        ...
        "status": "design",
        "statusLabel": "In design",
        "statusDetail": "IR, control flow, and shared compiler infrastructure.",
        "summary": "Shared compiler primitives and intermediate representation.",
        ...
        "notes": [
            "Shared infrastructure for downstream compiler work.",
            "A good candidate for architecture docs and examples."
        ]
    },
    {
        "slug": "aspen",
