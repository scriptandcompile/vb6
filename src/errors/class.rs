...
pub enum ClassError {
    ...
    #[error("After the 'VERSION' keyword there should be a space before the major version number.")]
    WhitespaceMissingBetweenVersionAndMajorVersionNumber,

    /// The 'VERSION' keyword is not fully uppercase.
    #[error(
        "The 'VERSION' keyword should be in uppercase to be fully compatible with Microsoft's VB6 IDE."
    )]
    ...
    #[error(
        "The 'CLASS' keyword should be in uppercase to be fully compatible with Microsoft's VB6 IDE."
    )]
    ...
    #[error(
        "The 'BEGIN' keyword should be in uppercase to be fully compatible with Microsoft's VB6 IDE."
    )]
    ...
    #[error(
        "Unable to parse the major version number. Following the 'VERSION' keyword should be a major version number, a '.', and a minor version number."
    )]
    UnableToParseMajorVersionNumber,

    /// Unable to convert the major version text to a number.
    #[error(
        "Unable to convert the major version text to a number. Following the 'VERSION' keyword should be a major version number, a '.', and a minor version number."
    )]
    UnableToConvertMajorVersionNumber,

    /// Unable to parse the minor version number.
    #[error(
        "Unable to parse the minor version number. Following the 'VERSION' keyword should be a major version number, a '.', and a minor version number."
    )]
    UnableToParseMinorVersionNumber,

    /// Unable to convert the minor version text to a number.
    #[error(
        "Unable to convert the minor version text to a number. Following the 'VERSION' keyword should be a major version number, a '.', and a minor version number."
    )]
    ...
    #[error(
        "Missing whitespace between minor version digits and 'CLASS' keyword. This may not be compliant with Microsoft's VB6 IDE."
    )]
    MissingWhitespaceAfterMinorVersion,

    /// Incorrect whitespace between minor version digits and 'CLASS' keyword.
    #[error(
        "Between the minor version digits and the 'CLASS' keyword should be a single ASCII space. This may not be compliant with Microsoft's VB6 IDE."
    )]
    IncorrectWhitespaceAfterMinorVersion,

    /// Whitespace was used to divide between major and minor version numbers.
    #[error(
        "Whitespace was used to divide between major and minor version information. This may not be compliant with Microsoft's VB6 IDE."
    )]
