 ...
 * @returns {any}
 */
function parse_vb6_code(code, _file_type) {
    try {
...
exports.parse_vb6_code = parse_vb6_code;
 ...
 * @returns {any}
 */
function tokenize_vb6_code(code) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
...
exports.tokenize_vb6_code = tokenize_vb6_code;
...
const wasmPath = `${__dirname}/vb6parse_bg.wasm`;
