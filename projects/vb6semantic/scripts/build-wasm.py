#!/usr/bin/env python3
"""
Cross-platform WASM build script for the VB6Semantic playground.
...
def main():
    parser = argparse.ArgumentParser(
        description="Build VB6Semantic WASM module for playground"
    )
    parser.add_argument(
        "--optimize",
        action="store_true",
    ...
    output_dir = workspace_root / "docs" / "vb6semantic" / "assets" / "wasm"

    print("=" * 60)
    print("VB6Semantic WASM Build Script")
    print("=" * 60)
    ...
    if args.optimize:
        wasm_file = output_dir / "vb6semantic_bg.wasm"
