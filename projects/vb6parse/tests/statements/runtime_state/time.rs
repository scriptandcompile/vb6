//! VB6 Time statement syntax:
//! - Time = time
//!
//! Sets the system time.
//!
//! time: Required. Any numeric expression, string expression, or any combination
//! that can represent a time.
//!
//! Note: The Time statement sets the computer's system time to the specified
//! time value. To retrieve the current system time, use the Time function.
//!
//! [Reference](https://learn.microsoft.com/en-us/office/vba/language/reference/user-interface-help/time-statement)
...
"#;
        ...
        settings.set_snapshot_path("../../../snapshots/tests/statements/runtime_state/time");
