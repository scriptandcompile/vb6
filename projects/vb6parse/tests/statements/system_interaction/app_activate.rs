//! Tests for `AppActivate` statement parsing.
//!
//! This module verifies parsing of VB6 `AppActivate` statements for activating
//! application windows:
...
"#;
        ...
        settings.set_snapshot_path(
            "../../../snapshots/tests/statements/system_interaction/app_activate",
        );
