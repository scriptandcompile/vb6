...
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/bitrate_calculator/form";

#[test]
fn bitrate_calculator_about_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../../test-data/Bitrate-calculator/Windows/Source-code/frmAbout.frm"
    );
...
fn bitrate_calculator_main_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../../test-data/Bitrate-calculator/Windows/Source-code/frmMain.frm"
    );
