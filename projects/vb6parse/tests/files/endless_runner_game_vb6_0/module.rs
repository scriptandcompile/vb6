use vb6parse::*;
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/endless_runner_game_vb6_0/module";

#[test]
fn endless_runner_game_vb6_0_module1_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/Endless-runner-Game_VB6.0/Endless runner project files/Module1.bas"
    );
