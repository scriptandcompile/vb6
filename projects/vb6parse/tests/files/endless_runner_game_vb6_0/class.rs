use vb6parse::*;
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/endless_runner_game_vb6_0/class";

#[test]
fn endless_runner_game_vb6_0_game_class_load() {
    let class_bytes = include_bytes!(
        "../../../../../test-data/Endless-runner-Game_VB6.0/Endless runner project files/game.cls"
    );
...
fn endless_runner_game_vb6_0_game2_class_load() {
    let class_bytes = include_bytes!(
        "../../../../../test-data/Endless-runner-Game_VB6.0/Endless runner project files/game2.cls"
    );
