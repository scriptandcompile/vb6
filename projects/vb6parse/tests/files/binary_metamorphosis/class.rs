use vb6parse::*;
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/binary_metamorphosis/class";

#[test]
fn binary_metamorphosis_v1_common_dialog_class_load() {
    let file_path =
        "../../test-data//Binary-metamorphosis/Binary metamorphosis V1.0/src/cCommonDialog.cls";
...
fn binary_metamorphosis_v2_common_dialog_class_load() {
    let file_path =
        "../../test-data//Binary-metamorphosis/Binary metamorphosis V2.0/src/cCommonDialog.cls";
    let class_bytes = std::fs::read(file_path).expect("Failed to read class file");
...
fn binary_metamorphosis_v3_common_dialog_class_load() {
    let file_path =
        "../../test-data//Binary-metamorphosis/Binary metamorphosis V3.0/src/cCommonDialog.cls";
    let class_bytes = std::fs::read(file_path).expect("Failed to read class file");
