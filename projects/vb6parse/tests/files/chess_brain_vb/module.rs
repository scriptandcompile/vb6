use vb6parse::*;
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/chess_brain_vb/module";

#[test]
fn chess_brain_vb_board_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/ChessBrainVB/ChessbrainVB_V4_10/Modules/Board.bas"
    );
...
fn chess_brain_vb_const_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/ChessBrainVB/ChessbrainVB_V4_10/Modules/Const.bas"
    );
...
fn chess_brain_vb_debug_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/ChessBrainVB/ChessbrainVB_V4_10/Modules/Debug.bas"
    );
...
fn chess_brain_vb_process_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/ChessBrainVB/ChessbrainVB_V4_10/Modules/Process.bas"
    );
...
fn chess_brain_vb_search_module_load() {
    let module_bytes = include_bytes!(
        "../../../../../test-data/ChessBrainVB/ChessbrainVB_V4_10/Modules/Search.bas"
    );
