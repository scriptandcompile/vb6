...
const SNAPSHOT_PATH: &str = "../../../snapshots/parsers/files/audiostation/form";
...
fn audiostation_about_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_About.frm");
...
fn audiostation_busy_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Busy.frm");
...
fn audiostation_init_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Init.frm");
...
fn audiostation_main_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Main.frm");
...
fn audiostation_midi_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Midi.frm");
...
fn audiostation_normalize_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Normalize.frm");
...
fn audiostation_open_dialog_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_OpenDialog.frm");
...
fn audiostation_playlist_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Playlist.frm");
...
fn audiostation_plugins_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Plugins.frm");
...
fn audiostation_settings_recorder_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../../test-data/audiostation/Source/Forms/Form_Settings_Recorder.frm"
    );
...
fn audiostation_settings_record_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../../test-data/audiostation/Source/Forms/Form_Settings_Record.frm"
    );
...
fn audiostation_streams_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_Streams.frm");
...
fn audiostation_system_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../../test-data/audiostation/Source/Forms/Form_System.frm");
...
fn audiostation_track_properties_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../../test-data/audiostation/Source/Forms/Form_Track_Properties.frm"
    );
