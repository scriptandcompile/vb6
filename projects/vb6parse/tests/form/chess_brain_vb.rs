...
fn chess_brain_vb_debugmain_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../test-data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/DebugMain.frm"
    );
...
fn chess_brain_vb_frmchessx_form_load() {
    let form_file_bytes = include_bytes!(
        "../../../../test-data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/frmChessX.frm"
    );
...
fn chess_brain_vb_main_form_load() {
    let form_file_bytes =
        include_bytes!("../../../../test-data/ChessBrainVB/ChessBrainVB_V4_03a/Source/Forms/Main.frm");
