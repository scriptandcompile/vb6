 ...
 * @returns {any}
 */
export function analyze_vb6_code(code, file_type) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(file_type, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.analyze_vb6_code(retptr, ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vb6semantic_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
